...
#define OCCUPY_IO_DATA_MIN 1000

#define OCCUPY_DATA_SAMPLE_SIZE 120
#define OCCUPY_DATA_SAMPLE_DELAY 50
#define OCCUPY_DATA_SOUND_THRESHOLD 10
#define OCCUPY_DATA_LIGHT_TOLERANCE 20
#define OCCUPY_DATA_MOTION_THRESHOLD 500

#define OCCUPY_DISPLAY_MIN_BRIGHTNESS 50
